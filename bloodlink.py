...
<style>
    ...
    /* Add padding to both sides so central content doesn't overlap the fixed edge menus */
    ...
    /* SIDEBAR (Now only used for branding and reset button) */
    ...
    /* ======================================================
       SOFT BREATHING ANIMATION (Eye-Friendly)
       ====================================================== */
    ...
    /* 3. Base shape for ALL collapsed edge icons */
    div[data-testid="stRadio"] div[role="radiogroup"] > label {
        ...
        /* Apply the eye-friendly soft breathing shadow */
        animation: soft-breathe 4s infinite ease-in-out !important;
    }

    /* Stop the breathing animation on hover or when active */
    div[data-testid="stRadio"] div[role="radiogroup"] > label:hover,
    div[data-testid="stRadio"] div[role="radiogroup"] > label:has(input:checked) {
        animation: none !important;
    }

    /* 4. LEFT SIDE TABS (1 to 4) */
    ...
    div[data-testid="stRadio"] div[role="radiogroup"] > label:nth-child(n+5) {
        ...
        display: flex !important;
        justify-content: flex-end !important; /* Pushes emoji to the right edge when collapsed */
    }
    div[data-testid="stRadio"] div[role="radiogroup"] > label:nth-child(n+5) p {
        text-align: right !important; /* Expands text leftward */
        width: 100% !important;
    ...
    /* "LOGIC DONORS" TITLE FOR RIGHT TABS */
    div[data-testid="stRadio"] div[role="radiogroup"] > label:nth-child(5)::before {
        content: "LOGIC DONORS";
        position: fixed;
        right: 15px;
        top: calc(15vh - 35px); /* Positioned just above the 5th tab */
        font-size: 15px;
        font-weight: 800;
        color: #7f1d1d;
    ...
    /* 6. Expand width on hover */
    div[data-testid="stRadio"] div[role="radiogroup"] > label:hover { 
        width: 220px !important; 
        box-shadow: 0 8px 20px rgba(0,0,0,0.25) !important;
    }
    
    /* Slightly wider active state */
    div[data-testid="stRadio"] div[role="radiogroup"] > label:has(input:checked) { 
    ...
    /* 7. Text inside the navigation tabs */
    ...
    /* 8. Vertical Positioning for each tab (Spanning the FULL EDGE using vh) */
    ...
    /* ======================================================
       HERO (With Algerian Font applied to title)
       ====================================================== */
    .hero { 
    ...
    .hero-subtitle { color: #fee2e2 !important; font-size: 23px; font-family: 'Baguet Script', 'Lucida Handwriting', cursive !important; margin-top: 8px; }
